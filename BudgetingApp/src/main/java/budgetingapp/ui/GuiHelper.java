...
public class GuiHelper {
    ...
    /**
     * Muuttaa kategorian nimestä tunnusnumeroksi
     *
     * @param category kategoria Stringinä
     * @return kategoriaan liittyvä tunnus int-muotoisena
     */
    ...
    /**
     * Muuttaa int-muotoisen kategoriatunnuksen Stringiksi
     *
     * @param category kategoriatunnus
     * @return kategoria Stringinä
     */
    ...
    /**
     * Muuttaa kuukauden Stringistä int-muotoiseksi
     *
     * @param month kuukausi
     * @return kuukauden järjestysnumero
     */
